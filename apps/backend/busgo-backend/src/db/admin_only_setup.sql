/*
  BusGo Admin-Only Setup SQL
  Use this when your base schema already exists and full_setup.sql fails on users.id type mismatch.
*/
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'bus_routes')
  AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'drivers' AND column_name = 'route_id') THEN
...
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'buses')
  AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'buses' AND column_name = 'registration')
  AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'buses' AND column_name = 'driver_id')
  AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'buses' AND column_name = 'bus_number') THEN
    UPDATE buses SET
